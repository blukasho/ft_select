...
badd +37 srcs/out.c
badd +23 srcs/read.c
badd +1 srcs/window.c
badd +70 includes/ft_select.h
badd +0 srcs/cursor.c
badd +0 Makefile
argglobal
silent! argdel *
argadd srcs/clear.c
argadd srcs/window.c
argadd srcs/read.c
argadd srcs/out.c
argadd srcs/main.c
argadd srcs/keys.c
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 46 - ((28 * winheight(0) + 25) / 50)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
46
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 87 - ((39 * winheight(0) + 25) / 50)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
87
